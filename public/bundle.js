...
(() => {
  ...
  var n = document.querySelector(".todo-list"),
    o = document.querySelector(".add-todo"),
    i = document.querySelector(".todo-form");
  console.log(i),
    console.log(o),
    i.addEventListener(
      "submit",
                ...
                function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          ...
                          fetch("http://localhost:3000/todo", {
                            ...
                            body: JSON.stringify({ todo: o.value }),
                          })
                        );
                      case 4:
                        if ((i = t.sent).ok) {
                      ...
                      case 9:
                        (a = t.sent),
                          ((c = document.createElement("li")).innerHTML =
                            a.todo),
                          n.appendChild(c),
                          (o.value = ""),
